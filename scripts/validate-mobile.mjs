...
const v9Css=readFileSync(new URL("../app/okfl-v9.css",import.meta.url),"utf8");
...
assert.ok(v9Css.includes(".v9Shell .mobileHeader .mobileMenuButton")&&v9Css.includes('.mobileMenuButton[aria-expanded="true"]'),"The mobile menu icon must override legacy button fills and expose its open state.");

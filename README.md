...
- Draft Room V4.3 with a full-width, high-legibility draft board; a streamlined player table and strategy panel; daily 10-team PPR market data; kickers and defenses; protected offline depth; autosave; and final grades
- Commissioner repair and live Sleeper synchronization tools

## Visual system

Version 4.1 introduced the Clubhouse visual system across desktop and mobile. Version 4.2 added a live, attributed PPR draft market. Version 4.3 rebuilds the Draft Room as a focused night-mode workspace with larger board cells, stronger hierarchy, and cleaner desktop and mobile layouts.

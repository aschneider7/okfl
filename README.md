...
- Live Draft Room with a six-character invite code, ten PIN-protected franchise seats, synchronized picks, reconnect-safe storage, online presence, commissioner controls, and bot picks for open seats
- Commissioner repair and live Sleeper synchronization tools

## Visual system

Version 4.1 introduced the Clubhouse visual system across desktop and mobile. Version 4.2 added a live, attributed PPR draft market. Version 4.3 rebuilt the Mock Draft Room as a focused night-mode workspace. Version 5.0 adds the separate multiplayer Live Draft Room without changing the mock simulator.

## Live Draft setup

1. Run `supabase/003_live_draft_rooms.sql` in the existing Supabase project after migrations 001 and 002.

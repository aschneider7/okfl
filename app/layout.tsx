...
const title = "OKFL OS 6.3 · Live League Intelligence";
...
export const metadata: Metadata = {
  ...
  openGraph: {title, description, type: "website", images: [{url: "/og-v2.png", width: 1536, height: 1024, alt: "OKFL OS League Intelligence, Live"}]},

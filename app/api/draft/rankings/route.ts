...
import {buildFfcDraftPool, fallbackRankingsMeta} from "@/lib/draftRankings";

const RANKINGS_URL = "https://fantasyfootballcalculator.com/api/v1/adp/ppr?teams=10&year=2026";
...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json(buildFfcDraftPool(await response.json(), fallback), {

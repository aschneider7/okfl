...
export default function CommissionerSettingsPage(){
  ...
  if(!session||!account)return <section className="accountGate card"><span className="eyebrow">Commissioner settings</span><h1>Sign in with a Commissioner account.</h1><p>Website controls are available only through a verified Commissioner account.</p><Link href="/login?next=/commissioner/settings">Commissioner sign in</Link></section>;

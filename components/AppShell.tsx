...
const links = [
  ["/", "Home", "HM"], ["/power-rankings", "Power Rankings", "PR"], ["/franchises", "Franchises", "FR"], ["/compare", "Compare", "VS"],
...
const mobileLinks = links.filter(([href]) => ["/", "/power-rankings", "/trades", "/live-draft", "/records"].includes(href));
